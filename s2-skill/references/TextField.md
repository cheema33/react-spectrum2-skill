...
| `type` | `(string & {}) | "search" | "text" | "url" | "tel" | "email" | "password" | undefined` | 'text' | The type of input to render. See [MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#htmlattrdeftype). |
