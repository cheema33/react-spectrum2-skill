...
| `aria-dropeffect` | `"link" | "none" | "copy" | "move" | "execute" | "popup" | undefined` | — | Indicates what functions can be performed when a dragged object is released on the drop target. |
...
| `inlist` | `any` | — |  |
| `inputMode` | `"search" | "text" | "none" | "url" | "tel" | "email" | "numeric" | "decimal" | undefined` | — | Hints at the type of data that might be entered by the user while editing the element or its contents |
